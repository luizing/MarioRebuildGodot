...
const KOOPA_FULL_SHAPE = preload("res://Resources/Colission_shapes/koopaFull.tres")
const KOOPA_SHEEL_SHAPE = preload("res://Resources/Colission_shapes/koopa_shell.tres")
...
func die():
	...
	collision_shape_2d.set_deferred("shape", KOOPA_SHEEL_SHAPE)
